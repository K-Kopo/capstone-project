    ...
    return (
        <div className="about-page">
            <section className="about-page__main">
              <img className="about-page__main--infographic" src={food_waste_graphic} alt="food waste infographic"/>
            </section>
            <aside>
                <p className="about-page__main--text">Food waste on this planet is an enormous issue.</p>
                <p className="about-page__main--text">New Orleans is one of the most revered cities for food in the world.</p>
